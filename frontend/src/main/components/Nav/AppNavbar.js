    ...
    <>
      ...
      <Navbar expand="xl" variant="dark" bg="dark" sticky="top" data-testid="AppNavbar">
        <Container>
          ...
          <Nav className="me-auto">
            {
              ((hasRole(currentUser, "ROLE_ADMIN") && hasRole(currentUser,"ROLE_USER")) || (hasRole(currentUser, "ROLE_USER") &&hasRole(currentUser, "ROLE_INSTRUCTOR")) || hasRole(currentUser, "ROLE_USER")) && (
                <>
